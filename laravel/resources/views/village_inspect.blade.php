			...
			<div style="background-color:rgba(245, 222, 179, 0.096)">
				...
				<div class="container">
					...
					<div class="container text-center">
						...
						<div class="container padding-top: 20px"> <h5>Dostępne jednostki:</h5></div>
						<div class="container">Pikinierzy: {{$tgt_pikeman->number ?? 0}}</div>
						<div class="container">Miecznicy: {{$tgt_sordman->number ?? 0}}</div>
						<div class="container">Topornicy: {{$tgt_axman->number ?? 0}}</div>
						<div class="container">Rycerze: {{$tgt_knight->number ?? 0}}</div>
